...
var mouse_hovering_over_minicart = false;
...
(function($){
  $(document).ready(function(){
    var config = {
      ...
      out: function(){
        if (!mouse_hovering_over_minicart) {
          $("#minicart").slideUp();
        }
      }
    };
    ...
    $(document).on('mouseover', '#minicart', function(e){
      mouse_hovering_over_minicart = true;
      console.log(mouse_hovering_over_minicart);
    });
    $(document).on('mouseout', '#minicart', function(e){
      mouse_hovering_over_minicart = false;
      console.log(mouse_hovering_over_minicart);
      $("#minicart").slideUp();
    });
